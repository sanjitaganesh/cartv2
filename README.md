# Simple Interactive Shopping Cart

A shopping cart built using HTML, CSS, and vanilla JavaScript with dynamic quantity controls and real-time total calculation.
...
## Live Demo
Open https://sanjitaganesh.github.io/cartv2/
